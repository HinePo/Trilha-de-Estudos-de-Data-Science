...
### Advanced RAG
  ...
  - [Advanced RAG - Query Optimization](https://www.kaggle.com/code/gabrielvinicius/advanced-rag-query-optimization/notebook#Query-Rewrite) - [Gabriel Vinicius](https://www.kaggle.com/gabrielvinicius)
